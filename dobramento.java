...
class Tabela { // Classe principal da tabela
    ...
    public int hash(int elemento) { // Função de hash de dobramento.
        int metade1 = elemento / 10000;
        int metade2 = elemento % 10000;
        return (metade1 + metade2) % tamanho;
    }
...
public class dobramento {
    public static void main(String[] args) {
        ...
        System.out.println("FUNCAO DOBRAMENTO - " + numChaves + " - " + "Tamanho do vetor: 20.000");
